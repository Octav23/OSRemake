...
importPackage(org.rs2server.rs2.util.Misc)
...
function objectOptionOne416(player, object) {
	player.getActionSender().sendMessage("You play the church Organ.");
}

function objectOptionOne3500(player, object) {
	player.getActionSender().sendMessage("You play the church Organ.");
}

function objectOptionOne9611(player, object) {
	player.getActionSender().sendMessage("You search the crate but find only dust.");
}
