...
public class Server {
	...
	public static void main(String[] args) {
		...
		/*logger.info("Reading config file...(DEFAULTS.TMR)");//We currently don't use the config file..
		try {
			BufferedReader reader = new BufferedReader(new FileReader("./DEFAULTS.TMR"));
