...
public class ActionSender {
	...
	public void playMusic() {
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 51){
			playMusic(2);
		}
		if(player.getLocation().getX() / 64 == 48 && player.getLocation().getY() / 64 == 50){
			playMusic(3);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 56){
			playMusic(8);
		}
		if(player.getLocation().getX() / 64 == 51 && player.getLocation().getY() / 64 == 60){
			playMusic(9);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 50){
			playMusic(12);
		}
		if(player.getLocation().getX() / 64 == 52 && player.getLocation().getY() / 64 == 57){
			playMusic(14);
		}
		if(player.getLocation().getX() / 64 == 47 && player.getLocation().getY() / 64 == 52){
			playMusic(15);
		}
		if(player.getLocation().getX() / 64 == 45 && player.getLocation().getY() / 64 == 53){
			playMusic(18);
		}
		if(player.getLocation().getX() / 64 == 45 && player.getLocation().getY() / 64 == 54){
			playMusic(18);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 57){
			playMusic(34);
		}
		if(player.getLocation().getX() / 64 == 47 && player.getLocation().getY() / 64 == 50){
			playMusic(35);
		}
		if(player.getLocation().getX() / 64 == 47 && player.getLocation().getY() / 64 == 50){
			playMusic(36);
		}
		if(player.getLocation().getX() / 64 == 51 && player.getLocation().getY() / 64 == 50){
			playMusic(36);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 51){
			playMusic(49);
		}
		if(player.getLocation().getX() / 64 == 51 && player.getLocation().getY() / 64 == 49){
			playMusic(50);
		}
		if(player.getLocation().getX() / 64 == 44 && player.getLocation().getY() / 64 == 75){
			playMusic(52);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 53){
			playMusic(54);
		}
		if(player.getLocation().getX() / 64 == 49 && player.getLocation().getY() / 64 == 54){
			playMusic(56);
		}
		if(player.getLocation().getX() / 64 == 45 && player.getLocation().getY() / 64 == 75){
			playMusic(57);
		}
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 49){
			playMusic(64);
		}
		if(player.getLocation().getX() / 64 == 49 && player.getLocation().getY() / 64 == 49){
			playMusic(64);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 52){
			playMusic(72);
		}
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 50){
			playMusic(76);
		}
		if(player.getLocation().getX() / 64 == 48 && player.getLocation().getY() / 64 == 49){
			playMusic(85);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 49){
			playMusic(92);
		}
		if(player.getLocation().getX() / 64 == 51 && player.getLocation().getY() / 64 == 54){
			playMusic(93);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 55){
			playMusic(96);
		}
		if(player.getLocation().getX() / 64 == 48 && player.getLocation().getY() / 64 == 54){
			playMusic(98);
		}
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 52){
			playMusic(106);
		}
		if(player.getLocation().getX() / 64 == 44 && player.getLocation().getY() / 64 == 53){
			playMusic(119);
		}
		if(player.getLocation().getX() / 64 == 51 && player.getLocation().getY() / 64 == 51){
			playMusic(123);
		}
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 53){
			playMusic(125);
		}
		if(player.getLocation().getX() / 64 == 48 && player.getLocation().getY() / 64 == 53){
			playMusic(141);
		}
		if(player.getLocation().getX() / 64 == 48 && player.getLocation().getY() / 64 == 51){
			playMusic(151);
		}
		if(player.getLocation().getX() / 64 == 51 && player.getLocation().getY() / 64 == 52){
			playMusic(157);
		}
		if(player.getLocation().getX() / 64 == 51 && player.getLocation().getY() / 64 == 53){
			playMusic(157);
		}
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 55){
			playMusic(169);
		}
		if(player.getLocation().getX() / 64 == 49 && player.getLocation().getY() / 64 == 53){
			playMusic(175);
		}
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 54){
			playMusic(177);
		}
		if(player.getLocation().getX() / 64 == 46 && player.getLocation().getY() / 64 == 49){
			playMusic(180);
		}
		if(player.getLocation().getX() / 64 == 45 && player.getLocation().getY() / 64 == 52){
			playMusic(186);
		}
		if(player.getLocation().getX() / 64 == 49 && player.getLocation().getY() / 64 == 50){
			playMusic(327);
		}
		if(player.getLocation().getX() / 64 == 48 && player.getLocation().getY() / 64 == 52){
			playMusic(333);
		}
		if(player.getLocation().getX() / 64 == 50 && player.getLocation().getY() / 64 == 56){
			playMusic(337);
		}
		if(player.getLocation().getX() / 64 == 47 && player.getLocation().getY() / 64 == 56){
			playMusic(435);
		}
	}
	/**
	...
	public ActionSender interfaceComponent(int parentId, int childId, boolean show) {
	...
	public ActionSender sendLogin() {
		...
		break;
		case 1:
		sendString(Constants.MESSAGE_OF_THE_WEEK_SCREEN, 1, Constants.MESSAGE_OF_THE_WEEK2);
		break;
		case 2:
		sendString(Constants.MESSAGE_OF_THE_WEEK_SCREEN, 1, Constants.MESSAGE_OF_THE_WEEK3);
		break;
		case 3:
		sendString(Constants.MESSAGE_OF_THE_WEEK_SCREEN, 1, Constants.MESSAGE_OF_THE_WEEK4);
		break;
		}
		sendString(378, 15, " "+Constants.MESSAGE_LETTER+" ");
		int messages = 0;
		sendString(378, 16, " "+Constants.LETTER_OTHER_TEXT+" ");
		...
		sendString(378, 14, " "+Constants.MESSAGE_KEY+" ");
		sendString(378, 17, " "+Constants.MESSAGE_BANK_PIN+" ");
		...
		if(player.getLastLoggedIn() == 0) {
			player.getInventory().add(new Item(1351, 1));//Bronze Axe
			player.getInventory().add(new Item(590, 1));//Tinderbox
			player.getInventory().add(new Item(303, 1));//Fishing Net
			player.getInventory().add(new Item(315, 1));//Shrimps
			player.getInventory().add(new Item(1925, 1));//Bucket
			player.getInventory().add(new Item(1931, 1));//Pot
			player.getInventory().add(new Item(2309, 1));//Bread
			player.getInventory().add(new Item(1265, 1));//Pickaxe
			player.getInventory().add(new Item(1205, 1));//Bronze Dagger
			player.getInventory().add(new Item(1277, 1));//Bronze Sword
			player.getInventory().add(new Item(1171, 1));//Wooden Shield
			player.getInventory().add(new Item(841, 1));//Shortbow
			player.getInventory().add(new Item(882, 25));//25 Bronze Arrows
			player.getInventory().add(new Item(556, 25));//25 Air Runes
			player.getInventory().add(new Item(558, 15));//15 Mind runes
			player.getInventory().add(new Item(555, 6));//6 Water runes
			player.getInventory().add(new Item(557, 4));//4 Earth Runes
			player.getInventory().add(new Item(559, 2));//2 Body Runes
		} else {
		...
		sendInterface(Constants.LOGIN_SCREEN, 3, 17, true);
		...
		sendString(548, 26, "Report Abuse");
		...
		//player.checkForSkillcapes();// Auto-Trimming of capes
...
//				player.getRequestManager().setState(RequestState.NORMAL);
	...
	public ActionSender playMusic(int areaSound) {		
