...
public class ActionButtonPacketHandler implements PacketHandler {
	...
	public void handle(final Player player, Packet packet) {
		...
		player.getActionSender().sendDebugPacket(packet.getOpcode(), "ActionButton", new Object[] { "Interface: " + interfaceId, "Button: " + button, "ChildButton: " + childButton });
				System.out.println( "Interface: " + interfaceId+" Button: " + button+ "ChildButton: "+ childButton +" ");
		
		switch(interfaceId) {
		case 52:
			player.getCanoes().clickCanoeInterface(player, button);
			break;
		case 53:
			player.getCanoes().clickTravelInterface(player, button);
			break;
		case 382:
			switch(button) {
			case 18:
		...
		case 548:
			...
			case 21:
				//Trade
				break;
			case 24://Report abuse
			player.getActionSender().sendMessage("unavailable.");
			break;
			default:
		...
		case 311:
			 ...
			 */
			case 48://1
				Smithing.furnaceSmelting(player, 85, 451, 453, 8, 2363, 1, 50, false, true);
				break;
			case 47://5
				Smithing.furnaceSmelting(player, 85, 451, 453, 8, 2363, 5, 50, false, true);
				break;
			case 46://10
				Smithing.furnaceSmelting(player, 85, 451, 453, 8, 2363, 10, 50, false, true);
				break;
			case 45://x 
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2363);
				break;
				/*
				 * Adamant bars.
				 */
			case 44://1
				Smithing.furnaceSmelting(player, 70, 449, 453, 4, 2361, 1, 37.5, false, true);
				break;
			case 43://5
				Smithing.furnaceSmelting(player, 70, 449, 453, 6, 2361, 5, 37.5, false, true);
				break;
			case 42://10
				Smithing.furnaceSmelting(player, 70, 449, 453, 6, 2361, 10, 37.5, false, true);
				break;
			case 41://x 
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2361);
				break;
				/*
				 * Mithril
				 */
			case 40://1
				Smithing.furnaceSmelting(player, 50, 447, 453, 4, 2359, 1, 30, false, true);
				break;
			case 39://5
				Smithing.furnaceSmelting(player, 50, 447, 453, 4, 2359, 5, 30, false, true);
				break;
			case 38://10
				Smithing.furnaceSmelting(player, 50, 447, 453, 4, 2359, 10, 30, false, true);
			case 37://x 
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2359);
				break;
				/*
				 * Gold
				 */
			case 36://1
				Smithing.furnaceSmelting(player, 40, 444, 444, 1, 2357, 1, 22.5, false, false);
				break;
			case 35://5
				Smithing.furnaceSmelting(player, 40, 444, 444, 1, 2357, 5, 22.5, false, false);
				break;
			case 34://10
				Smithing.furnaceSmelting(player, 40, 444, 444, 1, 2357, 10, 22.5, false, false);
				break;
			case 33://x (doing all for now)
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2357);
				break;
				/*
				 * Steel
				 */
			case 32://1
				Smithing.furnaceSmelting(player, 30, 440, 453, 2, 2353, 1, 17.5, false, true);
				break;
			case 31://5
				Smithing.furnaceSmelting(player, 30, 440, 453, 2, 2353, 5, 17.5, false, true);
				break;
			case 30://10
				Smithing.furnaceSmelting(player, 30, 440, 453, 2, 2353, 10, 17.5, false, true);
				break;
			case 29://x (doing all for now)
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2353);
				break;
				/*
				 * Silver
				 */
			case 28://1
				Smithing.furnaceSmelting(player, 20, 442, 442, 1, 2355, 1, 13.7, false, false);
				break;
			case 27://5
				Smithing.furnaceSmelting(player, 20, 442, 442, 1, 2355, 5, 13.7, false, false);
				break;
			case 26://10
				Smithing.furnaceSmelting(player, 20, 442, 442, 1, 2355, 10, 13.7, false, false);
				break;
			case 25://x (doing all for now)
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2355);
				break;
				/*
				 * Iron
				 */
			case 24://1
				Smithing.furnaceSmelting(player, 15, 440, 440, 1, 2351, 1, 12.5, true, false);
				break;
			case 23://5
				Smithing.furnaceSmelting(player, 15, 440, 440, 1, 2351, 5, 12.5, true, false);
				break;
			case 22://10
				Smithing.furnaceSmelting(player, 15, 440, 440, 1, 2351, 10, 12.5, true, false);
				break;
			case 21://x (doing all for now)
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2351);
				break;
				/*
				 * Blurite /skip.
				 */
				 ...
				 */	
			case 16: //1
				Smithing.furnaceSmelting(player, 1, 438, 436, 1, 2349, 1, 6.2, false, true);
				break;
			case 15: //5
				Smithing.furnaceSmelting(player, 1, 438, 436, 1, 2349, 5, 6.2, false, true);
				break;
			case 14: // 10
				Smithing.furnaceSmelting(player, 1, 438, 436, 1, 2349, 10, 6.2, false, true);
				break;
			case 13: // x (doing all for now)
				//player.getInterfaceState().openEnterAmountInterface(interfaceId, 2349);
				break;
			default:
				logger.info("Unhandled buttonId: " + button + "on the smelting interface (probs just blurite)");
			}
			break;
		/**
		 * Leather crafting interface.
		...
		/*	case 304:
			//if(player.getCraftingVariables().isCrafting()) {
				switch(button) {
				case 1:
								System.out.println("we're here111");
				Crafting.dragonLeatherCrafting(player, button);
				System.out.println("we're here");
				break;
				default:				logger.info("Unhandled action button : " + interfaceId + " - " + button + " - " + childButton);
				break;*/
				//}
			//}
		/*
