...
public class Doors {
	...
	public boolean handleDoor(int id, int x, int y, int z) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) { 
			...
			World.getWorld().register(new GameObject(Location.create(d.doorX, d.doorY, d.doorZ), -1, d.type, 0, false));
		...
		World.getWorld().register(new GameObject(Location.create(d.doorX, d.doorY, d.doorZ), d.doorId, d.type, getNextFace(d), false));
