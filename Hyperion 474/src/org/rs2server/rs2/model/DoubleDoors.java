...
public class DoubleDoors {
	...
	public void changeLeftDoor(DoubleDoors d) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) { 
			...
			World.getWorld().register(new GameObject(Location.create(d.x, d.y, d.z), -1, 0, 0, false));
		...
		World.getWorld().register(new GameObject(Location.create(d.x, d.y, d.z), d.doorId, 0, getNextLeftFace(d), false));
	...
	public void changeRightDoor(DoubleDoors d) {
		...
		World.getWorld().register(new GameObject(Location.create(d.x, d.y, d.z), d.doorId, 0, getNextRightFace(d), false));
	}
