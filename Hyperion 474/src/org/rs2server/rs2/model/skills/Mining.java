...
public class Mining extends HarvestingAction {
	...
	public static enum Rock {
		...
		/**
		 * We will give the player normal essence.
		 int log, int level, double experience, int respawnTimer, int oreCount, int[] objects, int[] replacementRocks
 		 */
		ESSENCE(1436, 1, 2 * Constants.EXP_MODIFIER, 1, 5000, new int[] { 2491 }, new int[] { 2491 }),
		// This is as close to non-depleting as I'm going to get.
		
		/**
		 * Clay ore.
		 */
		CLAY(434, 1, 4 * Constants.EXP_MODIFIER, 2, 1, new int[] { 2108, 2109 }, new int[] { 450, 451 }),		
		
		/**
		 * Copper ore.
		 */
		COPPER(436, 1, 17.5 * Constants.EXP_MODIFIER, 6, 1, new int[] { 2090, 2091}, new int[] { 450, 451 }),
		
		/**
		 * Tin ore.
		 */
		TIN(438, 1, 17.5 * Constants.EXP_MODIFIER, 6, 1, new int[] { 2094, 2095}, new int[] { 450, 451 }),
		
		/**
		 * Iron ore.
		 */
		IRON(440, 15, 35 * Constants.EXP_MODIFIER, 15, 1, new int[] { 2092, 2093 }, new int[] { 450, 451 }),
		
		/**
		 * Silver ore.
		 */
		SILVER(442, 20, 40 * Constants.EXP_MODIFIER, 100, 1, new int[] {2100, 2101 }, new int[] { 450, 451 }),
		
		/**
		 * Gold ore.
		 */
		GOLD(444, 40, 65 * Constants.EXP_MODIFIER, 100, 1, new int[] { 2098, 2099 }, new int[] { 450, 451 }),
		
		/**
		 * Coal ore.
		 */
		COAL(453, 30, 50 * Constants.EXP_MODIFIER, 50, 3, new int[] { 2096, 2097 }, new int[] { 450, 451 }),
		
		/**
		 * Mithril ore.
		 */
		MITHRIL(447, 55, 80 * Constants.EXP_MODIFIER, 200, 4, new int[] { 2102, 2103 }, new int[] { 450, 451 }),
		
		
		LUNAR(9076, 55, 80 * Constants.EXP_MODIFIER, 200, 4, new int[] { 14903 }, new int[] { 14916 }),
		
		/**
		 * Adamantite ore.
		 */
		ADAMANTITE(449, 70, 95 * Constants.EXP_MODIFIER, 400, 6, new int[] { 2104, 2105 }, new int[] { 450, 451 }),
		
		/**
		 * Rune ore.
		 */
		RUNE(451, 85, 215 * Constants.EXP_MODIFIER, 1000, 8, new int[] { 2106, 2107 }, new int[] { 450, 451 })
