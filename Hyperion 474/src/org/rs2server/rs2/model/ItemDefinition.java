...
definitions[11665] = new ItemDefinition(11665, "Void melee helm", "", false, false, false, 11665, 10347, true, 250);
definitions[11664] = new ItemDefinition(11664, "Void ranger helm", "This needs refining.", false, false, false, 11664, 10347, true, 250);definitions[11663] = new ItemDefinition(11663, "Void mage helm", "This needs refining.", false, false, false, 11663, 10347, true, 250);

			definitions[8839] = new ItemDefinition(8839, "Void knight top", "This needs refining.", false, false, false, 8839, 10347, true, 250);	
			definitions[8840] = new ItemDefinition(8840, "Void knight robe", "This needs refining.", false, false, false, 8840, 10347, true, 250);
definitions[8842] = new ItemDefinition(8842, "Void knight gloves", "This needs refining.", false, false, false, 8842, 10347, true, 250);
														
														
			definitions[9076] = new ItemDefinition(9076, "Lunar ore", "This needs refining.", false, false, false, 9076, 10347, true, 250);
				definitions[10034] = new ItemDefinition(10034, "Red Chinchompa", "Flammable!", false, false, true, 10034, 10347, true, 250);
				definitions[9096] = new ItemDefinition(9096, "Lunar helm", "A mystical helmet.", false, false, false, 9096, 10347, true, 250);
		definitions[9097] = new ItemDefinition(9097, "Lunar Torso", "Provides good protection.", false, false, false, 9097, 10347, true, 350);
		definitions[9098] = new ItemDefinition(9098, "Lunar legs", "Provides good protection.", false, false, false, 9098, 10347, true, 350);
		definitions[9099] = new ItemDefinition(9099, "Lunar gloves", "These should keep my hands safe.", false, false, false, 9099, 10347, true, 350);
		definitions[9100] = new ItemDefinition(9100, "Lunar boots", "Mystical foot protection.", false, false, false, 9100, 10347, true, 350);
		definitions[9101] = new ItemDefinition(9101, "Lunar cape", "Oooo pretty!", false, false, false, 9101, 10347, true, 350);
		definitions[10346] = new ItemDefinition(10346, "3rd Age Platelegs", "A set of very ancient platelegs.", false, false, false, 10346, 10347, true, 1250);
				definitions[1038] = new ItemDefinition(108, "Red partyhat", "A nice hat from a cracker.", false, true, false, 1038, 1039, true, 0);
			definitions[1039] = new ItemDefinition(1039, "Red partyhat", "Swap this note out in the bank.", true, false, false, 1038, 1039, true, 0);
			definitions[10398] = new ItemDefinition(10398, "Sleeping cap", "A cap for wearing whil...zzzzzzzzz", false, true, false, 10398, 10399, true, 17750);
			definitions[10399] = new ItemDefinition(10399, "Sleeping cap", "Swap this note out in the bank.", true, false, false, 10398, 10399, true, 17750);
						definitions[10392] = new ItemDefinition(10392, "A powdered wig", "A big do about nothing.", false, true, false, 10392, 10393, true, 17750);
			definitions[10393] = new ItemDefinition(10393, "A powdered wig", "Swap this note out in the bank.", true, false, false, 10392, 10393, true, 17750);
...
//			dump();
			...
			definitions[11286] = new ItemDefinition(11286, "Draconic visage", "It looks like this could be attached to a shield somehow.", false, false, true, 11286, 11286, true, 26750);
			definitions[11283] = new ItemDefinition(11283, "Dragonfire shield", "A heavy shield with a snarling, draconic visage.", false, false, false, 11283, 11283, true, 35750);
			...
			definitions[4561] = new ItemDefinition(4561, "Purple sweets", "Not likely to last until next Halloween.", false, false, true, 4561, 4561, true, 800);
			dump();
