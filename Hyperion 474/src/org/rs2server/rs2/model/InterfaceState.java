	...
	public void closeEnterAmountInterface(int amount) {
		try {
			...
			case Smithing.SMELTING_INTERFACE:
				...
				case 2363://Rune
					Smithing.furnaceSmelting(player, 85, 451, 453, 8, 2363, amount, 50, false, true);
					break;
				case 2361://Adamant
					Smithing.furnaceSmelting(player, 70, 449, 453, 4, 2361, amount, 37.5, false, true);
					break;
				case 2359://Mithril
					Smithing.furnaceSmelting(player, 50, 447, 453, 4, 2359, amount, 30, false, true);
					break;
				case 2357://Gold
					Smithing.furnaceSmelting(player, 40, 444, 444, 1, 2357, amount, 22.5, false, false);
					break;
				case 2353://Steel
					Smithing.furnaceSmelting(player, 30, 440, 453, 2, 2353, amount, 17.5, false, true);
					break;
				case 2355://Silver
					Smithing.furnaceSmelting(player, 20, 442, 442, 1, 2355, amount, 13.7, false, false);
					break;
				case 2351://Iron
					Smithing.furnaceSmelting(player, 15, 440, 440, 1, 2351, amount, 12.5, true, false);
					break;
				case 2349:
					Smithing.furnaceSmelting(player, 1, 438, 436, 1, 2349, amount, 6.2, false, true);
					break;
				}
				break;
			case 303:
			...
			case 306:
				...
				if(player.getCraftingVariables().isCrafting()) {
					...
					//case GREEN_DRAGON_LEATHER:
						Crafting.leatherCrafting(player, 63, amount, 1745, 3, 1135, 186);
					//	break;
					//case BLUE_DRAGON_LEATHER:
					//	Crafting.leatherCrafting(player, 71, amount, 2505, 3, 2499, 210);/
				//		break;
				//	case RED_DRAGON_LEATHER:
				//		Crafting.leatherCrafting(player, 77, amount, 2507, 3, 2501, 234);
				//		break;
				//	case BLACK_DRAGON_LEATHER:
				//		Crafting.leatherCrafting(player, 84, amount, 2509, 3, 2503, 258);
				//		break;
					//}
				}
				break;
