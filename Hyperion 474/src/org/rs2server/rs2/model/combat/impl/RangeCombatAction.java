...
public class RangeCombatAction extends AbstractCombatAction {
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		if (!special || (bowType == BowType.BRONZE_CBOW || bowType == BowType.IRON_CBOW || bowType == BowType.STEEL_CBOW
			...
			if(rangeWeaponType != null) {
				...
				|| rangeWeaponType == RangeWeaponType.BLACK_DART || rangeWeaponType != RangeWeaponType.CHINCHOMPA) {
					clientSpeed = 35;
					showDelay = 20;
					slope = 13;		
				} else {
			...
			if(rangeWeaponType == RangeWeaponType.CHINCHOMPA){
					clientSpeed = 50;
					showDelay = 20;
					slope = 10;
				victim.playGraphics(Graphic.create(157, 45, 100));					
			}
			} else {
	...
	public static enum RangeWeaponType {
		...
		CHINCHOMPA(1.0, null, 909, new int[] { 7, 7, 9 }),
		;
